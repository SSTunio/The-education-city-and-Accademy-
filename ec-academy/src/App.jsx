...
import AdminLogin from './pages/AdminLogin'; // Secret Admin Login
  ...
  return (
    <Router>
      <div className="app-container" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ background: 'var(--navy)', color: 'var(--gold)', textAlign: 'center', fontSize: '10px', padding: '4px', fontWeight: 'bold' }}>
          EDUCATION CITY ACADEMY v1.3 • SECURE PROTOCOL ACTIVE
        </div>
        ...
        <a 
          ...
          style={{
            position: 'fixed', bottom: '30px', right: '30px', width: '60px', height: '60px', backgroundColor: '#25d366', color: '#fff', borderRadius: '50px', textAlign: 'center', fontSize: '30px', boxShadow: '0 4px 15px rgba(0,0,0,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 10000
          }}
        >
